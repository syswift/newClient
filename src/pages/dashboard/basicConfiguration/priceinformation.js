...
import {TransTableRow, TransTableToolbar} from '../../../sections/@dashboard/basicConfiguration/priceinformation';
...
const TABLE_HEAD = [
  { id: 'goodsName', label: '商品名称', align: 'center', width: 300 },
...
PriceInformation.getLayout = function getLayout(page) {
    ...
    <Page title="价格信息">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <Scrollbar>
            <TableContainer sx={{ minWidth: 1100, position: 'relative' , overflow:'unset'}}>
              {selected.length > 0 && (
