...
import {TransTableRow, TransTableToolbar} from '../../../sections/@dashboard/basicConfiguration/terminalCustomerInformation';
...
const TABLE_HEAD = [
  { id: 'terminalCustomerCode', label: '终端客户代码', align: 'center', width: 100 },
  { id: 'terminalCustomerName', label: '终端客户名称', align: 'center', width: 100  },
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: '基础配置', herf: PATH_DASHBOARD.basicConfiguration.terminalCustomerInformation },
            { name: '终端客户信息'},
          ]}
          action={
            <NextLink href={PATH_DASHBOARD.basicConfiguration.newTerminalCustomer} passHref>
