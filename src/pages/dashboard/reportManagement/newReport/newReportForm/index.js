...
//
import ReportFormMandatory from './reportFormMandatory';
...
export default function NewReportForm({ isEdit, currentInvoice }) {
  ...
  const NewUserSchema = Yup.object().shape({
    reportCode: Yup.string().nullable().required('请完善相关信息！'),
    reportNumber: Yup.string().nullable().required('请完善相关信息！'),
  ...
  const defaultValues = useMemo(
    () => ({
      reportCode: currentInvoice?.reportCode || '',
      reportNumber: currentInvoice?.reportNumber || '',
