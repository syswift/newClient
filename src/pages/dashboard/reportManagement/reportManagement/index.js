...
import {TransTableRow, TransTableToolbar} from '../../../../sections/@dashboard/reportManagement/reportManagement';
...
const TABLE_HEAD = [
  { id: 'reportCode', label: '报表代码', align: 'center', width: 100 },
  { id: 'reportNumber', label: '报表单号', align: 'center', width: 100  },
