...
export default function TransTableRow({ row, selected, onSelectRow, onViewRow, onEditRow, onDeleteRow}) {
  ...
  const { reportCode, reportNumber, note, operationPerson, operationTime  } = row;
  ...
  return (
    ...
    <TableRow hover selected={selected}>
      ...
      <TableCell align="center">{reportCode}</TableCell>
      <TableCell align="center">{reportNumber}</TableCell>
